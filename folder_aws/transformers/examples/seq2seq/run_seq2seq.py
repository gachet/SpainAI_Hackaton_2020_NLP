...
early_stopping = EarlyStoppingCallback(early_stopping_patience=6, early_stopping_threshold=0.005)
...
def main():
    ...
    ### TODO: DELETE ALL THIS ONCE DEBUGGED
    # data_args, model_args, training_args = DataTrainingArguments, ModelArguments, Seq2SeqTrainingArguments
    # data_args.train_file = "prueba_peque_tr.csv"
    # data_args.validation_file = "prueba_peque_val.csv"
    # training_args.per_device_train_batch_size = 8
    # training_args.train_batch_size = 8
    # training_args.eval_batch_size = 8
    # training_args.per_device_eval_batch_size = 16
    # data_args.text_column = "description"
    # data_args.summary_column = "name"
    # model_args.max_source_length = 364
    # model_args.max_target_length = 60
    # training_args.evaluation_strategy = "steps"
    # training_args.num_train_epochs = 1
    # training_args.load_best_model_at_end = True
    # model_args.model_name_or_path = "t5-base"
    # training_args.output_dir = "prueba_0203"
    ...
    # training_args.deepspeed = "./folder_aws/ds_config.json"
    #########################################
    ...
    task_specific_params.update(
        {"summarization": {"min_length": 0, "max_length": 60, "length_penalty": 1.0, "num_beams": 1}}
    )
    ...
    output = trainer.predict(test_dataset["test"], num_beams=30, max_length=346)
    predictions_detokenized = [
        trainer.tokenizer.decode(pred, skip_special_tokens=True, clean_up_tokenization_spaces=False)
    ...
    save_submission_df(predictions, "/home/alejandro.vaca/SpainAI_Hackaton_2020/submission_2003.csv")
    return results
